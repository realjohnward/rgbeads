...
/**
 * @title ColoredPet Smart Contract
 * @author John Ward
 */
...
/**
 * @dev The ColoredPet main contract.
 *
 * Each ColoredPet token implements full on-chain metadata
 ...
 * returning metadata.
 */
contract ColoredPet is Ownable, ERC721Enumerable {
     ...
     * NOTE: For ColoredPet, there will only be 100 artist series IDs (1-100).
     ...
     * ColoredPet once metadata is locked, no updates to the metadata will be
    ...
    /**
     * @dev Batch transfer of ColoredPet NFTs from one address to another
        ...
        returns (string memory metadata)
    {
        ...
        metadata = string(abi.encodePacked(metadata, " ColoredPet #"));
    ...
    /**
     * @notice Mints an ColoredPet NFT
    ...
    /**
     * @notice Mints multiple ColoredPet NFTs for same series and nftType
     * @param to address of the recipient
     * @param seriesId series to mint
     * @param nftType the type of nft - 1 for 2D piece, 2 for 3D piece
     ...
     */
    function batchMintColoredPetNft(
        address to,
        uint256 seriesId,
        uint256 nftType,
